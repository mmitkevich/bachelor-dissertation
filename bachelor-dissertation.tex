...
\include{Dissertation/chapter1}        % Глава 1 -- лит. обзор
%\include{Dissertation/chapter1.5}	   % Глава 1.5 -- теория, построение мат. модели
\include{Dissertation/chapter2}        % Глава 2 -- числ. решение
\include{Dissertation/chapter3}		   % Глава 3 -- проверка программы
\include{Dissertation/chapter4}	       % Глава 4 -- числ. эксп
